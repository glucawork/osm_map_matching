...
<qgis symbologyReferenceScale="-1" simplifyDrawingHints="1" version="3.38.0-Grenoble" styleCategories="AllStyleCategories" simplifyAlgorithm="0" simplifyDrawingTol="1" maxScale="0" simplifyLocal="1" readOnly="0" labelsEnabled="0" hasScaleBasedVisibilityFlag="0" minScale="0" simplifyMaxScale="1">
  <flags>
  ...
  <temporal durationField="" accumulate="0" startField="" startExpression="" enabled="0" limitMode="0" endField="" durationUnit="min" mode="0" endExpression="" fixedDuration="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation binding="Centroid" extrusion="0" respectLayerSymbol="1" symbology="Line" zoffset="0" showMarkerSymbolInSurfacePlots="0" clamping="Terrain" type="IndividualFeatures" extrusionEnabled="0" zscale="1">
    ...
    <profileLineSymbol>
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="line" name="">
        ...
        <layer id="{9b01d3c1-ca1d-4da3-a77a-55015920d0bb}" enabled="1" locked="0" class="SimpleLine" pass="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="fill" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{51fe2d05-d932-410b-b9ea-8f2b5eba9255}" enabled="1" locked="0" class="SimpleFill" pass="0">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="marker" name="">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{7a730cee-1aaa-42cc-80ee-74b12527799f}" enabled="1" locked="0" class="SimpleMarker" pass="0">
          <Option type="Map">
  ...
  <renderer-v2 referencescale="-1" forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
    <rules key="{f5c2f346-f843-4db5-8b84-4dba668e0873}">
      <rule symbol="0" filter="&quot;highway&quot; = 'path' or &quot;highway&quot;='footway' or &quot;highway&quot;='track'" key="{2d3c9f93-1770-4f66-bb6c-2675ee1fcf35}"/>
      <rule symbol="1" filter="ELSE" key="{7464dd47-9871-4756-ad17-3a71823fb779}"/>
    </rules>
    <symbols>
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="line" name="0">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
        ...
        <layer id="{374ee215-4353-4251-8466-1d6503264f44}" enabled="1" locked="0" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="round" type="QString" name="capstyle"/>
            <Option value="1;3" type="QString" name="customdash"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="customdash_map_unit_scale"/>
            <Option value="MM" type="QString" name="customdash_unit"/>
            <Option value="0" type="QString" name="dash_pattern_offset"/>
            <Option value="3x:0,0,0,0,0,0" type="QString" name="dash_pattern_offset_map_unit_scale"/>
            ...
            <Option value="255,7,247,255,hsv:0.83888888888888891,0.97254901960784312,1,1" type="QString" name="line_color"/>
      ...
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="line" name="1">
        <data_defined_properties>
          <Option type="Map">
            <Option value="" type="QString" name="name"/>
            <Option name="properties"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="line" name="">
        ...
        <layer id="{c5ef2c34-f7d7-4d95-9de1-521ed1912dcd}" enabled="1" locked="0" class="SimpleLine" pass="0">
          <Option type="Map">
            <Option value="0" type="QString" name="align_dash_pattern"/>
            <Option value="square" type="QString" name="capstyle"/>
            <Option value="5;2" type="QString" name="customdash"/>
  ...
  <SingleCategoryDiagramRenderer attributeLegend="1" diagramType="Histogram">
    <DiagramCategory opacity="1" lineSizeType="MM" showAxis="1" penWidth="0" rotationOffset="270" width="15" sizeType="MM" height="15" penColor="#000000" scaleDependency="Area" maxScaleDenominator="0" spacingUnit="MM" lineSizeScale="3x:0,0,0,0,0,0" enabled="0" sizeScale="3x:0,0,0,0,0,0" backgroundAlpha="255" barWidth="5" spacing="5" diagramOrientation="Up" backgroundColor="#ffffff" scaleBasedVisibility="0" minScaleDenominator="0" spacingUnitScale="3x:0,0,0,0,0,0" labelPlacementMethod="XHeight" penAlpha="255" direction="0" minimumSize="0">
      <fontProperties strikethrough="0" description="Ubuntu,10,-1,5,50,0,0,0,0,0" style="" bold="0" underline="0" italic="0"/>
      <axisSymbol>
        <symbol clip_to_extent="1" frame_rate="10" is_animated="0" alpha="1" force_rhr="0" type="line" name="">
          <data_defined_properties>
            <Option type="Map">
          ...
          <layer id="{7c324d15-fd3b-4d08-86fb-0c75dfa24f96}" enabled="1" locked="0" class="SimpleLine" pass="0">
            <Option type="Map">
              <Option value="0" type="QString" name="align_dash_pattern"/>
              <Option value="square" type="QString" name="capstyle"/>
              <Option value="5;2" type="QString" name="customdash"/>
  ...
  <DiagramLayerSettings zIndex="0" showAll="1" priority="0" obstacle="0" placement="2" dist="0" linePlacementFlags="18">
    <properties>
      <Option type="Map">
        <Option value="" type="QString" name="name"/>
        <Option name="properties"/>
  ...
  <fieldConfiguration>
    ...
    <field configurationFlags="NoFlag" name="service">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="motorcycle">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="tracktype">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="access">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="motorcar">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="crossing">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="footway">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="motor_vehicle">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
    ...
    <field configurationFlags="NoFlag" name="source:maxspeed">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    ...
    <alias index="1" field="maxspeed" name=""/>
    <alias index="2" field="source" name=""/>
    <alias index="3" field="name" name=""/>
    <alias index="4" field="service" name=""/>
    <alias index="5" field="lanes" name=""/>
    <alias index="6" field="motorcycle" name=""/>
    <alias index="7" field="ref" name=""/>
    <alias index="8" field="tracktype" name=""/>
    <alias index="9" field="access" name=""/>
    <alias index="10" field="motorcar" name=""/>
    <alias index="11" field="surface" name=""/>
    <alias index="12" field="bicycle" name=""/>
    <alias index="13" field="crossing" name=""/>
    <alias index="14" field="oneway" name=""/>
    <alias index="15" field="footway" name=""/>
    <alias index="16" field="highway" name=""/>
    <alias index="17" field="motor_vehicle" name=""/>
    <alias index="18" field="lit" name=""/>
    <alias index="19" field="source:maxspeed" name=""/>
  </aliases>
  <splitPolicies>
  ...
  <defaults>
    ...
    <default expression="" applyOnUpdate="0" field="motorcycle"/>
    <default expression="" applyOnUpdate="0" field="ref"/>
    <default expression="" applyOnUpdate="0" field="tracktype"/>
    <default expression="" applyOnUpdate="0" field="access"/>
    <default expression="" applyOnUpdate="0" field="motorcar"/>
    <default expression="" applyOnUpdate="0" field="surface"/>
    <default expression="" applyOnUpdate="0" field="bicycle"/>
    <default expression="" applyOnUpdate="0" field="crossing"/>
    <default expression="" applyOnUpdate="0" field="oneway"/>
    <default expression="" applyOnUpdate="0" field="footway"/>
    <default expression="" applyOnUpdate="0" field="highway"/>
    <default expression="" applyOnUpdate="0" field="motor_vehicle"/>
    <default expression="" applyOnUpdate="0" field="lit"/>
    <default expression="" applyOnUpdate="0" field="source:maxspeed"/>
  </defaults>
  <constraints>
  ...
  <attributetableconfig sortOrder="0" sortExpression="" actionWidgetStyle="dropDown">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="source:maxspeed"/>
...
control = dialog.findChild(QWidget, "MyLineEdit")
  ...
  <reuseLastValue>
    ...
    <field reuseLastValue="0" name="motorcycle"/>
    ...
    <field reuseLastValue="0" name="source:maxspeed"/>
